...
(function ($) {
	...
	// Hover Icon coin for footer
	$('.bcs-link').hover(function(){
		$(this).attr("src","./img/BSC-footer-1.png");
	}, function(){
		$(this).attr("src","./img/BSC-footer.png");
	})
	
	$('.market-link').hover(function(){
		$(this).attr("src","./img/coinMarket-footer-8.png");
	}, function(){
		$(this).attr("src","./img/coinMarket-footer-7.png");
	})

	$(".gecko-link").hover(function(){
		$(this).attr("src","./img/coinGecko-footer-1.png");
	}, function(){
		$(this).attr("src","./img/coinGecko-footer.png");
	})
